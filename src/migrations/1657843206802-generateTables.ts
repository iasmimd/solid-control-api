...
export class generateTables1657843206802 implements MigrationInterface {
    name = 'generateTables1657843206802'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "providers_supplies_orders" ("providersId" uuid NOT NULL, "ordersId" uuid NOT NULL, CONSTRAINT "PK_ecbdf64c10ec9bc6be6674d8900" PRIMARY KEY ("providersId", "ordersId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_43569df324b23714b26a5f66c7" ON "providers_supplies_orders" ("providersId") `);
        await queryRunner.query(`CREATE INDEX "IDX_5bcb29cfc0ed5fc8df4ed33bfc" ON "providers_supplies_orders" ("ordersId") `);
        ...
        await queryRunner.query(`CREATE TABLE "orders_provider_id_providers" ("ordersId" uuid NOT NULL, "providersId" uuid NOT NULL, CONSTRAINT "PK_593f0268782d70190015dc4c4dc" PRIMARY KEY ("ordersId", "providersId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f9fc9b879f004d4aaaf9f9b077" ON "orders_provider_id_providers" ("ordersId") `);
        await queryRunner.query(`CREATE INDEX "IDX_9d747fd202019d53563b951a79" ON "orders_provider_id_providers" ("providersId") `);
        ...
        await queryRunner.query(`ALTER TABLE "providers_supplies_orders" ADD CONSTRAINT "FK_43569df324b23714b26a5f66c77" FOREIGN KEY ("providersId") REFERENCES "providers"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "providers_supplies_orders" ADD CONSTRAINT "FK_5bcb29cfc0ed5fc8df4ed33bfc8" FOREIGN KEY ("ordersId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "orders_provider_id_providers" ADD CONSTRAINT "FK_f9fc9b879f004d4aaaf9f9b077d" FOREIGN KEY ("ordersId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "orders_provider_id_providers" ADD CONSTRAINT "FK_9d747fd202019d53563b951a79e" FOREIGN KEY ("providersId") REFERENCES "providers"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders_provider_id_providers" DROP CONSTRAINT "FK_9d747fd202019d53563b951a79e"`);
        await queryRunner.query(`ALTER TABLE "orders_provider_id_providers" DROP CONSTRAINT "FK_f9fc9b879f004d4aaaf9f9b077d"`);
        ...
        await queryRunner.query(`ALTER TABLE "providers_supplies_orders" DROP CONSTRAINT "FK_5bcb29cfc0ed5fc8df4ed33bfc8"`);
        await queryRunner.query(`ALTER TABLE "providers_supplies_orders" DROP CONSTRAINT "FK_43569df324b23714b26a5f66c77"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9d747fd202019d53563b951a79"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f9fc9b879f004d4aaaf9f9b077"`);
        await queryRunner.query(`DROP TABLE "orders_provider_id_providers"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5bcb29cfc0ed5fc8df4ed33bfc"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_43569df324b23714b26a5f66c7"`);
        await queryRunner.query(`DROP TABLE "providers_supplies_orders"`);
