...
export class generateTables1657843860079 implements MigrationInterface {
    name = 'generateTables1657843860079'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "providers_orders_orders" ("providersId" uuid NOT NULL, "ordersId" uuid NOT NULL, CONSTRAINT "PK_9355c979443cf95ecefaa98f35b" PRIMARY KEY ("providersId", "ordersId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8f59962f0a4d330f6bf1fb2703" ON "providers_orders_orders" ("providersId") `);
        await queryRunner.query(`CREATE INDEX "IDX_ba7fda307f2a620e76c656788f" ON "providers_orders_orders" ("ordersId") `);
        ...
        await queryRunner.query(`ALTER TABLE "providers_orders_orders" ADD CONSTRAINT "FK_8f59962f0a4d330f6bf1fb27034" FOREIGN KEY ("providersId") REFERENCES "providers"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "providers_orders_orders" ADD CONSTRAINT "FK_ba7fda307f2a620e76c656788f4" FOREIGN KEY ("ordersId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "orders_provider_providers" ADD CONSTRAINT "FK_7c74a55c1e38828a5ec048abb0d" FOREIGN KEY ("providersId") REFERENCES "providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "providers_orders_orders" DROP CONSTRAINT "FK_ba7fda307f2a620e76c656788f4"`);
        await queryRunner.query(`ALTER TABLE "providers_orders_orders" DROP CONSTRAINT "FK_8f59962f0a4d330f6bf1fb27034"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ba7fda307f2a620e76c656788f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8f59962f0a4d330f6bf1fb2703"`);
        await queryRunner.query(`DROP TABLE "providers_orders_orders"`);
